var x = screen.width;
                        ...
                        var paese = ['Bezevo','Borovec','Drenok','Dolno Lukovo','Gorno Lukovo','Jablanica','Lakavica','Modric','Nerezi','Piskupshtina'];
                        ...
                        for(i = 0;i<10;i++){
                            var dad = '\
                              <div class="flip-container">\
                                  <div class="flipper">\
                                    <div class="front" style="border-radius: 0.5%"><img id="ale" src="images/homepage/' + cover[i] + '" width="' + w + '" height="' + h + '">\
                                      <div class="' + b + '">\
                                        <h' + n + ' style="color: white; filter:drop-shadow(8px 8px 10px black);">' + paese[i] + '</h' + n + '>\
                                      </div>\
                                    </div>\
                                    <div class="back" style="border-radius: 0.5%"><img id="ale" src="images/homepage/' + /*back[Math.floor(Math.random()*5)]*/ back[i] + '" width="' + w + '" height="' + h + '" style="filter:brightness(12%);">\
                                      <div class="btn-block"  style="' + a + '">\
                                        <a href="' + h_page[i] + '">\
                                          <button style="border-radius: 8px;" type="button" class="btn btn-pill btn-outline-primary al" href="' + h_page[i] + '"><img src="https://png.icons8.com/ios/25/ffffff/literature.png">&nbsp;&nbsp; Info</button>\
                                        </a>\
                                        <br>\
                                        <br>\
                                        <a href="' + pic_page[i] + '">\
                                          <button style="border-radius: 8px;" type="button" class="btn btn-pill btn-outline-primary al" href="'+ pic_page[i] + '"><img src="https://png.icons8.com/wired/25/ffffff/picture.png">&nbsp;&nbsp; Images</button>\
                                        </a>\
                                      </div>\
                                    </div>\
                                  </div>\
