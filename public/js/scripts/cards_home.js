...
var cover = ['cover.jpg','cover.jpg','drenok.jpg','dlukovo.jpg','glukovo.jpg','jablanica.jpg','cover.jpg','modric.jpg','nerezi.jpeg','piskupshtina.jpg'];
  ...
  var carta = '\
    <div class="flip-container">\
        <div class="flipper">\
          ...
          <div class="back" style="border-radius: 10px;"><img class="slikaselo" src="images/homepage/small/' + cover[i] + '" style="filter:brightness(25%);">\
            <div class="btn-block">\
              <a href="' + h_page[i] + '">\
