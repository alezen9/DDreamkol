...
router.get("/peopleSay", (req, res) => {
  ...
  if(lingua == "eng"){
    ...
    nota = "Внимание"
    nota1 = "Цел на странава е споделувањето на мисли, факти, пораки и се тоа сто може да биде во текст форма... Зборот на вас!";
    warning = "Секаков вид на навреди е строго забранет, пораката ке биде веднаш избришана и уредувачите ке преземаат соодветни мерки";
    titolo ="Искажисе!";
